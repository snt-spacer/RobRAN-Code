...
from omni.isaac.lab_tasks.rans import RaceWaypointsCfg, RaceWaypointsTask, TurtleBot2Robot, TurtleBot2RobotCfg


@configclass
class TurtleBot2RaceWaypointsEnvCfg(DirectRLEnvCfg):
...
class TurtleBot2RaceWaypointsEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: TurtleBot2RaceWaypointsEnvCfg
