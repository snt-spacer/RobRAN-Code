...
from omni.isaac.lab_tasks.rans import GoThroughPosesCfg, GoThroughPosesTask, KingfisherRobot, KingfisherRobotCfg
...
class KingfisherGoThroughPosesEnv(DirectRLEnv):
    ...
    def _setup_scene(self):
        ...
        self.robot_api = KingfisherRobot(
            self.cfg.robot_cfg, robot_uid=0, num_envs=self.num_envs, device=self.device, dt=self.cfg.sim.dt
        )
